...
if(!empty($login_user)){
    ...
    $query = $db->prepare("SELECT id, role_id FROM users WHERE s_status=1 && role_id=3 && id=? LIMIT 1");
...
<head>
  ...
  <title>IŞIK ADMIN - GİRİŞ YAP</title>
  <meta content="" name="description">

  <!-- Favicons -->
  <link href="assets/img/isik-uni-logo.png" rel="icon">
            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <div class="logo d-flex align-items-center w-auto">
                  <img src="assets/img/isik-uni-logo.png" alt="isik-logo">
                  <span class="d-none d-lg-block">IŞIK ADMIN</span>
                </div>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Kullanıcı Adı ve Parolanızı Giriniz</p>
                  </div>
                  <form class="row g-3 needs-validation dataform" novalidate action="login-control.php" method="post" enctype="multipart/form-data">
                    <div class="col-12">
                      <label for="yourUsername" class="form-label">Eposta Adresi</label>
                    ...
                    <div class="col-12">
                      ...
                      <div class="invalid-feedback">Parolanızı giriniz!</div>
                    </div>

                    <div class="col-12">
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" value="1" name="remember" id="flexSwitchCheckDefault">
                    ...
                    <div class="col-12">
                      <button class="btn btn-primary w-100 formsubmitbutton" type="submit">Giriş Yap</button>
                    </div>
                  </form>
